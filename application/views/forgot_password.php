      ...
      <div class="card-group">
        <div class="card bg-transparent2">
          <div class="card-block">
            <div class="center">
              <h4 class="m-b-0"><span class="icon-text">Silahkan Isi Email Untuk Reset Password</span></h4>
            </div>
            <form action="<?=base_url()?>auth/request_forgot" method="post" id="form_forgot">
              <div class="form-group">
                <input type="email" class="form-control" name="email" id="email" placeholder="Alamat Email">
              </div>
              <div class="center">
                <button type="submit" class="btn  btn-primary btn-rounded" id="tombol_request">
